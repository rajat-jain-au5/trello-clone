...
import{ addList, addCard} from '../actionCreators/actions'
...
class AddActionButton extends React.Component {
    ...
    handleInputChange = e => {
      ...
      handleAddList = () => {
        ...
        const {listId,lists:{list}}= this.props
        
        if (text) {
          
          this.props.addList(text,listId,list.length)
        }
      ...
      handleAddCard = () =>{
        ...
        if (text) {
          ...
          this.props.addCard(text,listId,index)
        }
    ...
    addButton = () => {
        ...
        const buttonBgColor = list ? "#dfe3e6" : "inherit";
    ...
    renderForm = () => {
        ...
        return <div>
            ...
            <div style={styles.buttonGroup}>
                <Button onMouseDown={list ? this.handleAddList : this.handleAddCard} style={{color:"white",backgroundColor:"green"}}>
                    {buttonTitle}
                </Button>
