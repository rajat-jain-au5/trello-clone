...
class TrelloList extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        this.props.saveTitle(this.props.listId, this.props.index, this.props.lists.editTitle)
    }
                ...
                <Droppable droppableId={String(listId)}>
                  {(provided) => (
                    ...
                    >
                      ...
                      <DeleteIcon className="del" onClick={()=>this.props.handleDeleteList(listId)}></DeleteIcon>
                      ...
                      this.props.lists.list[this.props.index]._id ? (
                        ...
                        <h4
                          onClick={() =>
                            this.props.handleEditTitle(listId, index)
                          }
                        >
                          {title}
                        </h4>
                      ...
                      <AddActionButton listId={listId} index={index} />
